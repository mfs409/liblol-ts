...
FixtureProxy.prototype.Clone=function(){var clone=new FixtureProxy(this.fixture,this.aabb.Clone());clone.childIndex;clone.proxyId;return clone;};return FixtureProxy;})();Dynamics.FixtureProxy=FixtureProxy;var Fixture=(function(){function Fixture(){this.m_userData=null;this.m_body=null;this.m_proxies=[];this.m_filter=null;this.shape=null;this.m_density=0.0;}
Fixture.prototype.GetType=function(){return this.shape.GetType();};Fixture.prototype.GetShape=function(){return this.shape;};Fixture.prototype.SetSensor=function(sensor){if(sensor!=this.m_isSensor){this.m_body.SetAwake(true);this.m_isSensor=sensor;}};Fixture.prototype.IsSensor=function(){return this.m_isSensor;};Fixture.prototype.SetFilterData=function(filter){this.m_filter=filter;this.Refilter();};Fixture.prototype.GetFilterData=function(){return this.m_filter;};Fixture.prototype.Refilter=function(){if(this.m_body==null){return;}
...
var broadPhase=world.GetContactManager().m_broadPhase;for(var i=0;i<this.m_proxies.length;++i){broadPhase.TouchProxy(this.m_proxies[i].proxyId);}};Fixture.prototype.GetBody=function(){return this.m_body;};Fixture.prototype.GetUserData=function(){return this.m_userData;};Fixture.prototype.SetUserData=function(data){this.m_userData=data;};Fixture.prototype.TestPoint=function(p){return this.shape.TestPoint(this.m_body.GetTransform(),p);};Fixture.prototype.RayCast=function(input,childIndex){return this.shape.RayCast(input,this.m_body.GetTransform(),childIndex);};Fixture.prototype.GetMassData=function(){return this.shape.ComputeMass(this.m_density);};Fixture.prototype.SetDensity=function(density){PhysicsType2d.Assert(PhysicsType2d.MathExtensions.IsValid(density)&&density>=0.0);this.m_density=density;};Fixture.prototype.GetDensity=function(){return this.m_density;};Fixture.prototype.GetFriction=function(){return this.m_friction;};Fixture.prototype.SetFriction=function(friction){this.m_friction=friction;};Fixture.prototype.GetRestitution=function(){return this.m_restitution;};Fixture.prototype.SetRestitution=function(restitution){this.m_restitution=restitution;};Fixture.prototype.GetAABB=function(childIndex){PhysicsType2d.Assert(0<=childIndex&&childIndex<this.m_proxies.length);return this.m_proxies[childIndex].aabb.Clone();};Fixture.prototype.Dump=function(bodyIndex){PhysicsType2d.Utils.log("    FixtureDefinition fd;");PhysicsType2d.Utils.log("    fd.friction = {0};",this.m_friction);PhysicsType2d.Utils.log("    fd.restitution = {0};",this.m_restitution);PhysicsType2d.Utils.log("    fd.density = {0};",this.m_density);PhysicsType2d.Utils.log("    fd.isSensor = boolean({0});",this.m_isSensor);PhysicsType2d.Utils.log("    fd.filter.categoryBits = uint16({0});",this.m_filter.categoryBits);PhysicsType2d.Utils.log("    fd.filter.maskBits = uint16({0});",this.m_filter.maskBits);PhysicsType2d.Utils.log("    fd.filter.groupIndex = int16({0});",this.m_filter.groupIndex);switch(this.shape.GetType()){case 0:(function(){var s=this.shape;PhysicsType2d.Utils.log("    CircleShape shape;");PhysicsType2d.Utils.log("    shape.m_radius = {0};",s.m_radius);PhysicsType2d.Utils.log("    shape.m_p.Set({0}, {0});",s.m_p.x,s.m_p.y);})();break;case 1:(function(){var s=this.shape;PhysicsType2d.Utils.log("    EdgeShape shape;");PhysicsType2d.Utils.log("    shape.m_radius = {0};",s.m_radius);PhysicsType2d.Utils.log("    shape.m_vertex0.Set({0}, {1});",s.m_vertex0.x,s.m_vertex0.y);PhysicsType2d.Utils.log("    shape.m_vertex1.Set({0}, {1});",s.m_vertex1.x,s.m_vertex1.y);PhysicsType2d.Utils.log("    shape.m_vertex2.Set({0}, {1});",s.m_vertex2.x,s.m_vertex2.y);PhysicsType2d.Utils.log("    shape.m_vertex3.Set({0}, {1});",s.m_vertex3.x,s.m_vertex3.y);PhysicsType2d.Utils.log("    shape.m_hasVertex0 = boolean({0});",s.m_hasVertex0);PhysicsType2d.Utils.log("    shape.m_hasVertex3 = boolean({0});",s.m_hasVertex3);})();break;case 2:(function(){var s=this.shape;PhysicsType2d.Utils.log("    PolygonShape shape;");PhysicsType2d.Utils.log("    Vector2 vs[{0}];",PhysicsType2d.Settings.maxPolygonVertices);for(var i=0;i<s.m_vertices.length;++i){PhysicsType2d.Utils.log("    vs[{0}].Set({0}, {1});",i,s.m_vertices[i].x,s.m_vertices[i].y);}
PhysicsType2d.Utils.log("    shape.Set(vs, {0});",s.m_vertices.length);})();break;case 3:(function(){var s=this.shape;PhysicsType2d.Utils.log("    ChainShape shape;");PhysicsType2d.Utils.log("    Vector2 vs[{0}];",s.m_vertices.length);for(var i=0;i<s.m_vertices.length;++i){PhysicsType2d.Utils.log("    vs[{0}].Set({0}, {1});",i,s.m_vertices[i].x,s.m_vertices[i].y);}
