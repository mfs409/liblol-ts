...
module LOL {
    ...
    export class Obstacle extends Actor {
        ...
        /**
         * Draw an obstacle with an underlying box shape.  By default, the 
         * Obstacle will have no density, elasticity, or friction, and will have
         * a zIndex of 0.
         *
         ...
         * @param game: The current LOL game
         * @return The obstacle, so that it can be further modified
         */
        public static makeAsBox(x: number, y: number, width: number, height: number, imgName: string, game: Lol): Obstacle {
            let o = new Obstacle(width, height, imgName, game);
            o.setBoxPhysics(x, y, PhysicsType2d.Dynamics.BodyType.STATIC, game);
            game.activeLevel.actors.push(o);
            return o;
        }
         ...
         * @param game    The game into which we make this actor
         */
        constructor(width: number, height: number, imgName: string, game: Lol) {
            super(imgName, width, height, game);
            game.activeLevel.worldSprites.push(this);
        }
         ...
         */
        public onCollide(other: Actor, contact: PhysicsType2d.Dynamics.Contacts.Contact) {
            // TODO: not using a singleton makes this overly ugly... figure out a better plan?
            // Util.message("ERROR", "Obstacle.onCollide should not be reachable!");
        }
