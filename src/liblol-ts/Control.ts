...
module LOL {
     ...
     */
    export class Control extends Renderable {
        /**
         * Should we run code when this Control is touched?
         */
        public isTouchable: boolean = false;
         ...
         */
        public static addCallbackControl(x: number, y: number, width: number, height: number, imgName: string, callback: LolCallback, game: Lol): Control {
            let c = new Control(imgName, x, y, width, height, game);
            let ga = new GestureAction();
            ga.onTap = function (vv: PhysicsType2d.Vector3): boolean {
                callback.onEvent();
                return true;
            }
            c.gestureAction = ga;
         ...
         *                it will not crash.
         * @param x       The X coordinate (in pixels) of the top left corner.
         * @param y       The Y coordinate (in pixels) of the top left corner.
         * @param width   The width of the Control, in pixels
         * @param height  The height of the Control, in pixels
         * @param game    The game instance
         */
        constructor(imgName: string, x: number, y: number, width: number, height: number, game: Lol) {
